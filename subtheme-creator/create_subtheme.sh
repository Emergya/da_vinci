...
echo '
+------------------------------------------------------------------------+
| With this script you could quickly create da_vinci sub-theme     |
| In order to use this:                                                  |
| - da_vinci theme (this folder) should be in the contrib folder   |
+------------------------------------------------------------------------+
'
echo 'The machine name of your custom theme? [e.g. mycustom_da_vinci]'
read CUSTOM_DA_VINCI

echo 'Your theme name ? [e.g. My custom da_vinci]'
...
sed -i -e "s/SASS Bootstrap Starter Kit Subtheme/$CUSTOM_DA_VINCI_NAME/" $CUSTOM_DA_VINCI.info.yml
